...
def criar(prompt : str, personagens, timeline):
    print(prompt)
    if sys.chat == None: return "KEY INVALIDA", personagens, timeline
    else:
...
with gr.Blocks() as windows_stories:
    ...
    entrada.submit(criar, [entrada, personagens, timeline], [historia, personagens, timeline])
